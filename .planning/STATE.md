...
### Phase 1 Core ✅
- [x] Tauri Commands bridge
- [x] SQLite plugin + tables
- [x] Ollama API integration
- [x] Model Router logic
- [x] RAM Calculation (real values)
- [x] System Monitor (real GPU via nvidia-smi)
- [x] Shell Integration
- [x] Invisible Context (RAG)
- [x] Identity System Prompt
